...
GLAZE_RECIPES = [
    ...
    # ── Group 3: New collection 2 (Raku-type + standard) ────────────────────
    {
        "name": "Raku Green",
        "collection": "new_collection",
        "reference_batch_g": 400,
        "water_fraction": 0.8,
        "water_ml_per_2boards": 400,
        "coverage_note": "400ml/2papan",
        "special_kiln": "972°C/5 min hold",
        "ingredients": [
            ("Fritt Fajar",      0.8),
            ("Fritt Tom",        0.2),
            ("Yellow",           0.03),
    ...
    # ── Group 4: New collection 3 (Raku-type + standard) ────────────────────
    {
        "name": "Raku",
        "collection": "new_collection",
        "reference_batch_g": 3000,
        "water_fraction": 0.8,
        "water_ml_per_2boards": 400,
        "coverage_note": "400ml/2papan",
        "special_kiln": "972°C/5 min hold",
