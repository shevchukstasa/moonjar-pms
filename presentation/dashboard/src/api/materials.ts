...
export const materialsApi = {
  ...
  update: (id: string, data: Record<string, unknown>, factoryId?: string) =>
    apiClient.patch(`/materials/${id}`, data, { params: factoryId ? { factory_id: factoryId } : undefined }).then((r) => r.data),
  delete: (id: string, factoryId?: string) =>
    apiClient.delete(`/materials/${id}`, { params: factoryId ? { factory_id: factoryId } : undefined }).then((r) => r.data),
