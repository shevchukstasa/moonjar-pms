...
import { useUploadPdf, useCreateOrder } from '@/hooks/useOrders';
import { useFactories } from '@/hooks/useFactories';
import type { PdfParsedOrder, PdfParsedItem } from '@/api/orders';
      ...
      {step === 'preview' && parsedOrder && (
        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            />
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700">Document Date</label>
              <input
                type="date"
