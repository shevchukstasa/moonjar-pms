...
from api.models import Resource, KilnLoadingRule
...
def _serialize_kiln(resource: Resource, db: Session) -> dict:
    """Serialize a kiln resource with loading rules."""
...
async def update_kiln(
    ...
    if data.num_levels is not None:
        kiln.num_levels = data.num_levels
